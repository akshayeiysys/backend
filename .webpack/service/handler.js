...
exports.getCirculatingSupply = exports.getTotalSupply = undefined;
...
var getTotalSupply = exports.getTotalSupply = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var totalSupply, burnt, circ;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 3:
                        ...
                        _context.next = 6;
                        return contract.methods.balanceOf(process.env.BurnAddress).call();

                    case 6:
                        burnt = _context.sent;
                        circ = new _bignumber2.default(totalSupply).minus(new _bignumber2.default(burnt));
                        return _context.abrupt("return", success(circ.shiftedBy(-18).toNumber().toString()));
...
var getCirculatingSupply = exports.getCirculatingSupply = function () {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 6:
                        burnt = _context2.sent;
                        circ = new _bignumber2.default(totalSupply).minus(new _bignumber2.default(burnt));
                        return _context2.abrupt("return", success(circ.shiftedBy(-18).toNumber().toString()));

                    case 11:
                        _context2.prev = 11;
                        _context2.t0 = _context2["catch"](0);
                        return _context2.abrupt("return", (0, _responseLib.failure)(_context2.t0));
    ...
    return function getCirculatingSupply() {
...
var _pharmToken = __webpack_require__(/*! ./abi/pharmToken.json */ "./abi/pharmToken.json");

var _pharmToken2 = _interopRequireDefault(_pharmToken);
...
var contract = new web3.eth.Contract(_pharmToken2.default, process.env.PharmAddress);

function success(body) {
    return (0, _responseLib.buildResponse)(200, body, { "Cache-Control": "max-age=500" });
}
